...
| R-2.5 | #728 branch sweep (2026-07-23): 349 of 372 stale remote branches were deleted (22 confirmed merged into `main` via `git merge-base --is-ancestor`, then 327 more cross-referenced against closed-but-unmerged PRs per the audit's own remediation criteria). These 20 have **no PR history at all** — no signal either way that the work was reviewed or abandoned — so they were deliberately held back pending a human look, rather than deleted on an unverifiable guess: `claude/strange-chebyshev-58d336-track-b`, `claude/strange-chebyshev-58d336-track-c`, `claude/strange-chebyshev-58d336-track-d`, `feat/convex-migration`, `feat/enhanced-dev-seed`, `feat/phase-3-dashboards`, `feature/model-accessories`, `fix/design-violations-final`, `wip/bucket1-availability`, `wip/bucket1-counts`, `wip/bucket1-reservation`, `wip/bucket2-notif-woo`, `wip/bucket2-tokens-mra`, `wip/phaseb-brand-templates`, `wip/phaseb-categories`, `wip/phaseb-group-templates`, `wip/phaseb-locations`, `wip/phaseb-models`, `wip/phaseb-suppliers`, `wip/phaseb-test-profiles`. | These 20 branch names only | Jayden | 2026-08-22 |
