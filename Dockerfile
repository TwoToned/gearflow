...
ARG NEXT_PUBLIC_NATIVE_ASSET_NOTES_OPTIMISTIC
ARG NEXT_PUBLIC_NATIVE_LINEITEM_OPTIMISTIC
ARG NEXT_PUBLIC_NATIVE_KIT_NOTES_OPTIMISTIC
ARG NEXT_PUBLIC_NATIVE_PROJECT_NOTES_OPTIMISTIC
...
ENV DATABASE_URL=$DATABASE_URL \
    ...
    NEXT_PUBLIC_NATIVE_ASSET_NOTES_OPTIMISTIC=$NEXT_PUBLIC_NATIVE_ASSET_NOTES_OPTIMISTIC \
    NEXT_PUBLIC_NATIVE_LINEITEM_OPTIMISTIC=$NEXT_PUBLIC_NATIVE_LINEITEM_OPTIMISTIC \
    NEXT_PUBLIC_NATIVE_KIT_NOTES_OPTIMISTIC=$NEXT_PUBLIC_NATIVE_KIT_NOTES_OPTIMISTIC \
    NEXT_PUBLIC_NATIVE_PROJECT_NOTES_OPTIMISTIC=$NEXT_PUBLIC_NATIVE_PROJECT_NOTES_OPTIMISTIC
