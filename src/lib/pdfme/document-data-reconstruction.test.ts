...
describe("keystone reconstruction → full PDF pipeline", () => {
  ...
  describe("structure → filter → height → render", () => {
    ...
    const categories: CategoryForStructuring[] = [
      ...
      { id: "cat-audio", name: "Audio", sortOrder: 1, groups: [{ id: "g1", title: "Mic Kit", description: null, quantity: 1, price: null, rentalPeriod: null, rentalQuantity: null, billingWeeks: null, billingDays: null, sortOrder: 0 }] },
    ];
