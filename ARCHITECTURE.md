...
| 55 | [Project Collaboration](./FEATUREDOCS/55-project-collaboration.md) | Convex-backed collaboration substrate for projects: presence + edit locks (entity/section/group/line targets, stale takeover), comment threads (blocking, resolve/reopen, mentions), review markers (needs-review/follow-up), group-level blocking gates, and a realtime activity feed. All state persists to Convex. |
