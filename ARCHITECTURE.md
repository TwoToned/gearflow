...
| 48 | [Discord Integration](./FEATUREDOCS/48-discord-integration.md) | Standalone discord.js bot, per-org DiscordIntegration, transactional outbox, HMAC trust boundary, error envelope, hardened /link enrollment |
