                ...
                {order.invoice ? (
                  <div className="flex items-center gap-2 rounded-[var(--r)] border border-line bg-paper-2/50 p-2.5">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-caption text-muted">{formatFileSize(order.invoice.fileSize)}</p>
                    </div>
                    <CanDo resource="supplier" action="update">
                      ...
                      >
                        {removeInvoiceMutation.isPending ? <Loader2 className="h-4 w-4 animate-spin" /> : <X className="h-4 w-4" />}
                      </button>
                    </CanDo>
                  </div>
                ) : (
