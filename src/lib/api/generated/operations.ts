...
export const OPERATIONS: Record<string, OperationMeta> = {
  ...
  "custom-roles.getCustomRole": { name: "custom-roles.getCustomRole", module: "custom-roles", fn: "getCustomRole", kind: "read", resource: "orgMembers", action: "read", scope: "orgMembers:read", params: [{ name: "id", type: "string", optional: false }], dangerous: true, summary: "Get a single custom role by ID */" },
  "custom-roles.getCustomRoles": { name: "custom-roles.getCustomRoles", module: "custom-roles", fn: "getCustomRoles", kind: "read", resource: "orgMembers", action: "read", scope: "orgMembers:read", params: [], dangerous: true, summary: "─── Read ───────────────────────────────────────────────────────────────────" },
  ...
  "org-members.getMentionableMembers": { name: "org-members.getMentionableMembers", module: "org-members", fn: "getMentionableMembers", kind: "read", resource: "orgMembers", action: "read", scope: "orgMembers:read", params: [], dangerous: true, summary: "Lightweight member directory for @mention pickers. Available to any org member" },
  "org-members.getOrgMembers": { name: "org-members.getOrgMembers", module: "org-members", fn: "getOrgMembers", kind: "read", resource: "orgMembers", action: "read", scope: "orgMembers:read", params: [{ name: "params", type: "{ page?: number; pageSize?: number; }", optional: true }], dangerous: true, summary: "" },
  "org-members.getPendingInvitations": { name: "org-members.getPendingInvitations", module: "org-members", fn: "getPendingInvitations", kind: "read", resource: "orgMembers", action: "read", scope: "orgMembers:read", params: [], dangerous: true, summary: "" },
  ...
  "settings.getMembers": { name: "settings.getMembers", module: "settings", fn: "getMembers", kind: "read", resource: "orgSettings", action: "read", scope: "orgSettings:read", params: [], dangerous: true, summary: "" },
  "settings.getNextAssetTag": { name: "settings.getNextAssetTag", module: "settings", fn: "getNextAssetTag", kind: "read", resource: "orgSettings", action: "read", scope: "orgSettings:read", params: [], dangerous: true, summary: "" },
  "settings.getOrganization": { name: "settings.getOrganization", module: "settings", fn: "getOrganization", kind: "read", resource: "orgSettings", action: "read", scope: "orgSettings:read", params: [], dangerous: true, summary: "" },
  "settings.getOrgTestTagSettings": { name: "settings.getOrgTestTagSettings", module: "settings", fn: "getOrgTestTagSettings", kind: "read", resource: "orgSettings", action: "read", scope: "orgSettings:read", params: [], dangerous: true, summary: "Get org-level T&T settings (for fallback defaults). */" },
  "settings.getPendingInvitations": { name: "settings.getPendingInvitations", module: "settings", fn: "getPendingInvitations", kind: "read", resource: "orgSettings", action: "read", scope: "orgSettings:read", params: [], dangerous: true, summary: "Get pending invitations for the current organization. */" },
  "settings.peekNextAssetTags": { name: "settings.peekNextAssetTags", module: "settings", fn: "peekNextAssetTags", kind: "read", resource: "orgSettings", action: "read", scope: "orgSettings:read", params: [{ name: "count", type: "unknown", optional: true }], dangerous: true, summary: "Read-only preview of the next N asset tags — does NOT increment the counter. */" },
  ...
  "sso.getOrgLoginInfo": { name: "sso.getOrgLoginInfo", module: "sso", fn: "getOrgLoginInfo", kind: "read", resource: "orgSettings", action: "read", scope: "orgSettings:read", params: [{ name: "orgSlug", type: "string", optional: false }], dangerous: true, summary: "─── Public Actions (no auth required) ───────────────────────────────────────" },
  "sso.getPendingApprovals": { name: "sso.getPendingApprovals", module: "sso", fn: "getPendingApprovals", kind: "read", resource: "orgSettings", action: "read", scope: "orgSettings:read", params: [], dangerous: true, summary: "─── Pending Approvals ───────────────────────────────────────────────────────" },
  "sso.getSSOProviders": { name: "sso.getSSOProviders", module: "sso", fn: "getSSOProviders", kind: "read", resource: "orgSettings", action: "read", scope: "orgSettings:read", params: [], dangerous: true, summary: "─── SSO Providers (read via Prisma, CRUD via Better Auth API) ───────────────" },
  "sso.getSSOSettings": { name: "sso.getSSOSettings", module: "sso", fn: "getSSOSettings", kind: "read", resource: "orgSettings", action: "read", scope: "orgSettings:read", params: [], dangerous: true, summary: "─── SSO Settings ────────────────────────────────────────────────────────────" },
...
export const OPERATION_COUNT = 509;
