...
export const agentOps: AgentOpsAnnotations = {
  list: { summary: "List crew availability rows for the org.", danger: "low", mcpTier: 2 },
  getById: { summary: "Get a single crew availability row by id.", danger: "low", mcpTier: 2 },
};
