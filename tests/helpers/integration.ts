...
// Domain fixture factories (model / bulkAsset / asset / kit) were removed:
// those Prisma models are dropped — domain data is now Convex-native, so the
// integration harness only seeds the KEPT auth/org tables (org, user, member).
