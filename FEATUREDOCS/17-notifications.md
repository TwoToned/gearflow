...
| `incident_report` | New/open MaintenanceRecord with `incidentType` set (Report Issue or an immediate check-item FAIL) — see FEATUREDOCS/62 | `/warehouse/{projectId}` or `/maintenance/{id}` |
