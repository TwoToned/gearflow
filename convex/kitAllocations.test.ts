...
// replaceKitAllocation/clearKitAllocation are now browser-direct in
// convex/kitAllocationsWrites.ts (replaceNative/clearNative) — see
// convex/kitAllocationsWrites.test.ts for the money-guard + RBAC + cross-tenant coverage.
