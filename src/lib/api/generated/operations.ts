...
export const OPERATIONS: Record<string, OperationMeta> = {
  ...
  "api-keys.listApiKeys": { name: "api-keys.listApiKeys", module: "api-keys", fn: "listApiKeys", kind: "read", resource: "orgSettings", action: "read", scope: "orgSettings:read", params: [], dangerous: false, summary: "List this org's API keys (never returns a secret — only the display prefix). */" },
  ...
  "custom-roles.getCustomRole": { name: "custom-roles.getCustomRole", module: "custom-roles", fn: "getCustomRole", kind: "read", resource: "orgMembers", action: "read", scope: "orgMembers:read", params: [{ name: "id", type: "string", optional: false }], dangerous: false, summary: "Get a single custom role by ID */" },
  "custom-roles.getCustomRoles": { name: "custom-roles.getCustomRoles", module: "custom-roles", fn: "getCustomRoles", kind: "read", resource: "orgMembers", action: "read", scope: "orgMembers:read", params: [], dangerous: false, summary: "─── Read ───────────────────────────────────────────────────────────────────" },
  "custom-roles.updateCustomRole": { name: "custom-roles.updateCustomRole", module: "custom-roles", fn: "updateCustomRole", kind: "write", resource: "orgMembers", action: "update_role", scope: "orgMembers:update_role", params: [{ name: "id", type: "string", optional: false }, { name: "data", type: "{ name?: string; description?: string; color?: string; ssoGroupClaim?: string; permissions?: PermissionMap; }", optional: false }], dangerous: true, summary: "Update an existing custom role */" },
  ...
  "webhooks.getWebhookEvents": { name: "webhooks.getWebhookEvents", module: "webhooks", fn: "getWebhookEvents", kind: "read", resource: "orgSettings", action: "read", scope: "orgSettings:read", params: [], dangerous: false, summary: "The events an endpoint can subscribe to, with descriptions. Read-only. */" },
...
export const MODULE_LOADERS: Record<string, () => Promise<Record<string, unknown>>> = {
  ...
  "custom-roles": () => import("@/server/custom-roles"),
